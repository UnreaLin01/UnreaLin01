...
![Photo by Umberto on Unsplash](https://hackmd.io/_uploads/H1s4GAtt1g.jpg)
...
- Currently working on: **Wearable Device**
- Currently learning: **Edge Computing**
- Ask me about: **KiCad, STM32, nRF53**
...
- *UROP Student* @ [MIT City Science Lab, Taipei](https://www.csltaipeitech.com/)
- *Programmer* @ [FRC Team 8180](https://dreamer.youngvoice.tw/content/DreamWork.aspx?id=1217)

## 🛠️ Tools

Not a complete list! Sadly, there aren't many icons available for hardware-related tools 😥.

[![My Skills](https://skillicons.dev/icons?i=c,cpp,arduino,git,github,vscode,python,java,linux,matlab&theme=light)](https://skillicons.dev)
...
![image](https://hackmd.io/_uploads/SyOqfL5t1l.png)
*Pic.1 - 6 Layers HDI & RF PCB Layout*

![image](https://hackmd.io/_uploads/S10oCHcKyl.png)
*Pic.2 - 4 Layers FR4 PCB Layout of TTR8 Electronic Control Unit*

![image](https://hackmd.io/_uploads/r1sk6r5Kyl.png)
*Pic.3 - 4 Layers FR4 PCB Layout of TTR8 Power Control Unit*
